...
const updateVideo = async (req, res) => {
    ...
    try {
        ...
        const video = await ((_a = manuRepo.collection) === null || _a === void 0 ? void 0 : _a.findOneAndUpdate({ $and: [{ "_id": new bson_1.ObjectId(res.locals.manufacturer._id) }, { "videos.videoId": videoID }] }, { $set: { "videos.$": Object.assign({ videoId: videoID }, req.body) } }, { projection: { "manufacturerId": "$_id", "_id": 0, "videos": { $elemMatch: { "videoId": videoID } } } }));
        res.status(200).send({
            status: "success",
