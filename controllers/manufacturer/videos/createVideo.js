...
const createVideo = async (req, res) => {
    ...
    try {
        ...
        const updatedData = await ((_a = manuRepo.collection) === null || _a === void 0 ? void 0 : _a.findOneAndUpdate({ "_id": new bson_1.ObjectId(res.locals.manufacturer._id) }, { $push: { "videos": { "videoId": videoID, name: req.body.name,
