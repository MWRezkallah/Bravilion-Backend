...
const createEnquiry = async (req, res) => {
    ...
    try {
        ...
        const updatedData = await ((_a = manuRepo.collection) === null || _a === void 0 ? void 0 : _a.findOneAndUpdate({ "_id": new bson_1.ObjectId(res.locals.manufacturer._id) }, { $push: { "enquiries": { "enquiryId": enquiryID, name: req.body.name, question: req.body.question, answer: req.body.answer } } }, { projection: { "_id": 1 } }));
        res.status(200).send({
            status: "success",
