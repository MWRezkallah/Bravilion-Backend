...
const deleteEnquiry = async (req, res) => {
    ...
    try {
        ...
        const enquiry = await ((_a = manuRepo.collection) === null || _a === void 0 ? void 0 : _a.findOneAndUpdate({ $and: [{ "_id": new bson_1.ObjectId(res.locals.manufacturer._id) }, { "enquiries.enquiryId": enquiryID }] }, { $pull: { "enquiries": { "enquiryId": enquiryID } } }, { projection: { "manufacturerId": "$_id", "_id": 0, "enquiries": { $elemMatch: { "enquiryId": enquiryID } } } }));
        res.status(200).send({
            status: "success",
...
//# sourceMappingURL=deleteEnquiry.js.map