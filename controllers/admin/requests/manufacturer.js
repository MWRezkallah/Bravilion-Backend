...
exports.getRequestsByStatusForManufacturer = void 0;
const bson_1 = require("bson");
const repositories_1 = require("../../../repositories");
const getRequestsByStatusForManufacturer = async (req, res) => {
    var _a;
    try {
        let manuFilter = {};
        if (req.params.manufacturerId) {
            manuFilter = {
                "_id": new bson_1.ObjectId(req.params.manufacturerId)
            };
        }
        let filter = {};
        if (req.body.status) {
...
exports.getRequestsByStatusForManufacturer = getRequestsByStatusForManufacturer;
