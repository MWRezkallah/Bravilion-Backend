...
router.post('/create-category', upload.fields([{ name: 'coverImage', maxCount: 1 }, { name: 'icon', maxCount: 1 }]), category_controller_1.createCategory);
...
router.put('/update-category/:id', upload.fields([{ name: 'coverImage', maxCount: 1 }, { name: 'icon', maxCount: 1 }]), category_controller_1.updateCategory);
