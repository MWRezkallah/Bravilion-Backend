...
router.post('/create-HomePage', upload.any(), controllers_1.createHomePage);
router.get('/get-HomePages', controllers_1.getHomePages);
router.get('/get-HomePage/:id', controllers_1.getHomePage);
router.put('/update-HomePage/:id', upload.any(), controllers_1.updateHomePage);
router.delete('/delete-HomePage/:id', controllers_1.deleteHomePage);
